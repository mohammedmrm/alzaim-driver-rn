					...
					<View style={{ flex: 1, marginBottom: 10, paddingBottom: 5 }}>
						<View style={styles.orderDetailsContainer}>
							...
							<View style={styles.textContainer}>
								...
								<ListItemOrderDetail caption="أسم الزبون" details={order.customer_name} order={order} />
								<ListItemOrderDetail onPress={true} caption="هاتف الزبون" details={order.customer_phone} order={order} />
								{order.address ? (
									<ListItemOrderDetail
								...
								{order.client_phone && (
									<ListItemOrderDetail onPress={true} caption="هاتف العميل" details={order.client_phone} order={order} />
								)}
								{order.money_status && (
