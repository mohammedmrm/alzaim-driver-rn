		...
		<View style={{ paddingTop: Constants.statusBarHeight, flex: 1 }}>
			...
			<FlatList
				...
				renderItem={({ item }) => (
					<OrderCard
						item={item}
						renderRightActions={() => <ListOrderCopyAction icon="content-copy" onPress={() => handleCopy(item)} />}
						renderLeftActions={() => <ListOrderCopyAction icon="content-copy" onPress={() => handleCopy(item)} />}
					/>
				)}
